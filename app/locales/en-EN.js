module.exports = {
    ...
    pseudonymRequired: "A username is required",
    pseudonymTooShort: "Your username must have at least 2 characters",
    pseudonymTooLong: "Your username can't be over 15 characters",
    ...
    emailPaypalNotEmpty: "Your paypal email can't be empty",
    invalidEmailPaypal: "Your paypal email isn't valid",
    ...
    wrongPasswordOrPseudonym: "Incorrect password or username",
    ...
    invalidRegexFirstname: "Your firstname can only contain uppercase or lowercase letters",
    invalidRegexLastname: "Your lastname can only contain uppercase or lowercase letters",
    invalidRegexPseudonym: "Your username can only contain letters, numbers, and - _",
    invalidRegexIban: "Your IBAN can only contain letters, numbers, and spaces",
    ...
    pseudonymAlreadyExists: "This username is already in use",
    ...
    googleUserCannotUpdateAccount: "Google users can't update their firstname, lastname, username, picture and email",
    ...
    groupThemeTooLong: "The group theme can't be over 30 characters",
    groupThemeRequired: "A group theme is required",
    ...
    adminCannotRemoveOwnMembership: "You're the only administrator of the group. Make another user administrator before leaving it.",
    adminCannotRevokeOwnAdminPrivilege: "You can't revoke your own administrator privilege.",
    notAllowedToUpdateGroupMembership: "You are not allowed to update the group user",
